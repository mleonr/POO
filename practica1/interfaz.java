...
public class interfaz{
	...
	public int menu(){
		...
		return JOptionPane.showOptionDialog(null,"Que operacion deseas realizar?","Banco",JOptionPane.YES_NO_CANCEL_OPTION,JOptionPane.QUESTION_MESSAGE,null,opciones,null);
	}
